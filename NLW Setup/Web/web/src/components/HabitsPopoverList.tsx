...
export const HabitsPopoverList = ({ date, onCompletedChange }: HabitsListProps) => {
  ...
  return (
          <div className='mt-6 flex flex-col gap-3'>
            {habitsInfo?.possibleHabits.map((habit) => {
              return(
                <Checkbox.Root
                  // tailwind + radix = "group" permite você estilizar divs genéricas com propriedades dos componentes da bibli. ex.:data-state
